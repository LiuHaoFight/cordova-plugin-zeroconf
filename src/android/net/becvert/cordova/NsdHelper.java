...
public class NsdHelper {
  ...
  public void handleServiceInfo(NsdServiceInfo serviceInfo) {
    try {
      ...
      newServiceInfo.add("type",
                         new JsonPrimitive(serviceInfo.getServiceType() + "."));
      newServiceInfo.add("name",
                         new JsonPrimitive(serviceInfo.getServiceName()));
      newServiceInfo.add("port", new JsonPrimitive(serviceInfo.getPort()));
      newServiceInfo.add(
          "hostname", new JsonPrimitive(serviceInfo.getHost().getHostName()));
  ...
  public NsdServiceInfo getChosenServiceInfo() { return mService; }
